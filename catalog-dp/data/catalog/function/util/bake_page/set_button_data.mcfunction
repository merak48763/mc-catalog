...
# (3) map_color
data modify storage catalog:zzz io.bake_page.out.button.components."minecraft:map_color" \
  set from storage catalog:zzz temp.bake_page.page_definition.button_color
